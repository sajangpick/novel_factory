...
/**
 * [작품 자료 페이지 — 2단 탐색기 레이아웃]
 * 왼쪽: 카테고리별 파일 목록 (접기/펼치기)
 * 오른쪽: 선택한 파일 내용 뷰어
 * 이 소설(무림MNA) 전용 자료만 표시. 장르 공통 DB는 자료실에서 별도 관리.
 */
...
// ── 작품 전용 파일 목록 (이 소설에서만 쓰는 22개) ──
// 장르 공통 파일(무공사전, 지리, 음식, 무기, 용어집 등)은 자료실 > 장르 공통 DB에서 관리
const WORLDDB_FILES: WorldDBFile[] = [
  ...
  { id: 'martial_pro', name: '주인공 무공 상세', path: 'novels/murim_mna/world_db/무공_주인공_상세.md', category: '🗡️ 무공' },
  ...
  { id: 'economy', name: '경제 시스템 심화', path: 'novels/murim_mna/world_db/경제_시스템_심화.md', category: '💰 경제사업' },
  { id: 'food_biz', name: '사업 음식기술', path: 'novels/murim_mna/world_db/사업_음식기술.md', category: '💰 경제사업' },
  { id: 'modern', name: '이준혁 현대지식 DB', path: 'novels/murim_mna/world_db/이준혁_현대지식_DB.md', category: '💰 경제사업' },
      ...
      <div className="flex-shrink-0 px-6 py-4 border-b border-murim-border bg-murim-darker/50">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">작품 자료</h1>
